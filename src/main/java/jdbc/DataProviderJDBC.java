...
import static jdbc.ConfigurationUtil.getConfigurationEntry;
...
public class DataProviderJDBC implements DataProvider{
    ...
    private Connection getConnection() throws IOException, SQLException {
        Connection connection = DriverManager.getConnection(
                getConfigurationEntry(Constants.JDBC_URL),
                getConfigurationEntry(Constants.JDBC_USER),
                getConfigurationEntry(Constants.JDBC_PASSWORD));
        return connection;
    }
